                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-300">
                            ...
                            <li><a href="/laptop" className="hover:text-white">Máy tính</a></li>
                            <li><a href="/mouse" className="hover:text-white">Chuột</a></li>
                            <li><a href="/headphone" className="hover:text-white">Tai nghe</a></li>
                        </ul>
                    </div>
                </div>
