...
export async function POST(request) {
  try {
    ...
    // SỬA: Tạo checkout ID với prefix cho thanh toán thẻ
    const baseId = doc(collection(db, `ids`)).id;
    const checkoutId = `p1_${baseId}`;
    console.log('Đã tạo ID thanh toán:', checkoutId);

    // Tạo line items với metadata productId
    ...
    // Lưu checkout session vào Firebase
