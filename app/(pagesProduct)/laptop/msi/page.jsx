...
export default function Page({ categoryFilter = null, params }) {
 ...
 const getCategoryInfo = () => {
    ...
    for (const parent of categories) {
      if (parent.children) {
        const msiSubCat = parent.children.find(child => {
          const name = child.name?.toLowerCase() || '';
          return name.includes('msi');
        });
        ...
        if (msiSubCat) {
          return {
            ...
            subCategoryId: msiSubCat.id,
            subCategoryName: msiSubCat.name
          };
        }
      }
    }
  ...
  const products = allProducts?.filter(product => {
    ...
    const isLaptop = categoryName.includes('msi') || 
                 
                   product.type === 'msi' ||
                   product.productType === 'msi' ||
                   product.category === 'msi';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
     ...
     <CommentsSection 
                   ...
                   subCategoryName={categoryInfo.subCategoryName || "Msi"}
