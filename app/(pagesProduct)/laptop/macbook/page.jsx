...
export default function Page({ categoryFilter = null, params }) {
  ...
  const findCategoryById = (categoryId) => {
   ...
   const getCategoryInfo = () => {
    ...
    for (const parent of categories) {
      if (parent.children) {
        const macbookSubCat = parent.children.find(child => {
        ...
        if (macbookSubCat) {
          return {
            ...
            subCategoryId: macbookSubCat.id,
            subCategoryName: macbookSubCat.name
          };
        }
      }
    }
  ...
  const products = allProducts?.filter(product => {
    ...
    const isLaptop = categoryName.includes('macbook') || 
                 
                   product.type === 'macbook' ||
                   product.productType === 'macbook' ||
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Comments Section */}
       <CommentsSection 
                   ...
                   subCategoryName={categoryInfo.subCategoryName || "Macbook"}
