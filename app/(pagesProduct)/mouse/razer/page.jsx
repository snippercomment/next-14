...
export default function Page({ categoryFilter = null, params }) {
  ...
  const getCategoryInfo = () => {
    ...
    for (const parent of categories) {
      if (parent.children) {
        const razerSubCat = parent.children.find(child => {
          const name = child.name?.toLowerCase() || '';
          return name.includes('razer');
        });
        ...
        if (razerSubCat) {
          return {
            ...
            subCategoryId: razerSubCat.id,
            subCategoryName: razerSubCat.name
          };
        }
      }
    }
  ...
  const products = allProducts?.filter(product => {
    ...
    const isLaptop = categoryName.includes('razer') || 
                 
                   product.type === 'razer' ||
                   product.productType === 'razer' ||
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <CommentsSection 
              ...
              subCategoryName={categoryInfo.subCategoryName || "Razer"}
