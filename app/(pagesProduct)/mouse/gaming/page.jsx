...
export default function Page({ categoryFilter = null, params }) {
  ...
  const getCategoryInfo = () => {
    ...
    for (const parent of categories) {
      if (parent.children) {
        const gamingSubCat = parent.children.find(child => {
        ...
        if (gamingSubCat) {
          return {
            ...
            subCategoryId: gamingSubCat.id,
            subCategoryName: gamingSubCat.name
          };
        }
      }
    }
  ...
  const products = allProducts?.filter(product => {
    ...
    const isLaptop = categoryName.includes('gaming') || 
                 
                   product.type === 'gaming' ||
                   product.productType === 'gaming' ||
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <CommentsSection 
              ...
              subCategoryName={categoryInfo.subCategoryName || "Gaming"}
