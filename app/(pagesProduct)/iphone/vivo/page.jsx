...
const getCategoryInfo = () => {
    ...
    for (const parent of categories) {
      if (parent.children) {
        const vivoSubCat = parent.children.find(child => {
          const name = child.name?.toLowerCase() || '';
          return name.includes('vivo');
        });
        ...
        if (vivoSubCat) {
          return {
            ...
            subCategoryId: vivoSubCat.id,
            subCategoryName: vivoSubCat.name
          };
        }
      }
    }
  ...
  const products = allProducts?.filter(product => {
    ...
    const isPhone = categoryName.includes('điện thoại') || 
                   categoryName.includes('vivo') ||
                   product.type === 'vivo' ||
                   product.productType === 'vivo' ||
                   product.category === 'vivo';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <CommentsSection 
                      ...
                      subCategoryName={categoryInfo.subCategoryName || "Vivo"}
